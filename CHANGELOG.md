...
## [0.3.0](https://github.com/Fuse-Technical-Group/pydecklink/compare/v0.2.11...v0.3.0) (2026-05-09)


### ⚠ BREAKING CHANGES

* **output:** remove schedule_frame, use pool API for scheduled playback

### Added

* 4K/60 DMA throughput benchmark ([72486bd](https://github.com/Fuse-Technical-Group/pydecklink/commit/72486bdc00103f88ec9ab0083c80f3f842d7fef7))
...
* add device_id and display_name properties to Card ([3cf6817](https://github.com/Fuse-Technical-Group/pydecklink/commit/3cf6817f01e7c641f2db2e9a1824e9fd16feb4e1))
...
* add video output and capture input bindings ([e6a1192](https://github.com/Fuse-Technical-Group/pydecklink/commit/e6a1192a8ce9417860b9d70d4b84618ce9c34d3f))
...
* **allocator:** accept Python callables for custom alloc/free ([3871501](https://github.com/Fuse-Technical-Group/pydecklink/commit/387150142fcda44675b764bf97f969fe1edbab3b))
* **allocator:** accept Python callables for custom alloc/free ([d7f1a5f](https://github.com/Fuse-Technical-Group/pydecklink/commit/d7f1a5f28c34b106347d8756814cb2f639fd0656))
* **allocator:** add custom video buffer allocator for GPU DMA ([b73f935](https://github.com/Fuse-Technical-Group/pydecklink/commit/b73f935024b74556680e3973ff649c9d4953d51b))
* **allocator:** custom video buffer allocator for GPU DMA ([ed5a00b](https://github.com/Fuse-Technical-Group/pydecklink/commit/ed5a00b13e8933677b37f0e9b562bcb684d3efec))
* **api:** bind IDeckLinkAPIInformation runtime version surface ([4657cfa](https://github.com/Fuse-Technical-Group/pydecklink/commit/4657cfa53d5970a5fb8764768ce279c7505f529f))
* **api:** define __all__ to control public API surface ([ea4b3aa](https://github.com/Fuse-Technical-Group/pydecklink/commit/ea4b3aa278b764355201929b98b3d9bb7296b2e1))
...
* bind DeckLink SDK enums, device, and format helpers ([14d2d33](https://github.com/Fuse-Technical-Group/pydecklink/commit/14d2d33d28e3c8762762473e7ebbdf1a164d514f))
* **bind:** add device ownership and improve autocirculate diagnostics ([5969edb](https://github.com/Fuse-Technical-Group/pydecklink/commit/5969edbd15efb74f2be1357dd9a25439d47e8f4a))
* **bindings:** add Device class and device enumeration ([4b642d2](https://github.com/Fuse-Technical-Group/pydecklink/commit/4b642d26dda577273e1eeb8c9cc01175b6d180f0))
* **bindings:** add device_id and display_name properties to Card ([ca4b19c](https://github.com/Fuse-Technical-Group/pydecklink/commit/ca4b19cc5bb9aee5dca0c96031604be04bf83469))
* **bindings:** add format metadata helpers ([89c051a](https://github.com/Fuse-Technical-Group/pydecklink/commit/89c051a9ece2880338fd405144f39538a69f83f0))
* **bindings:** add format metadata helpers (width, height, fps) ([6f38874](https://github.com/Fuse-Technical-Group/pydecklink/commit/6f388745c35f923e031b29bdec5fec06f2f663c1))
* **bindings:** bind core DeckLink SDK enums ([987a921](https://github.com/Fuse-Technical-Group/pydecklink/commit/987a92149ff924df784535aa96ecf1cca6317bde))
* **bindings:** bind DMAReadFrame and DMAWriteFrame for direct DMA ([e969d43](https://github.com/Fuse-Technical-Group/pydecklink/commit/e969d4310b17ecb271e8ba9d061f28ed51c3bff9))
* **bindings:** bind NTV2EveryFrameTaskMode as TaskMode enum ([5ae163f](https://github.com/Fuse-Technical-Group/pydecklink/commit/5ae163f39a8d2ed52a99766d24f6a2b2c3f097a4))
* **bindings:** expose playback-group sync enums ([84a9d6e](https://github.com/Fuse-Technical-Group/pydecklink/commit/84a9d6edcc6a2ece0b2eaf8393e35dfca8c8e639))
* **bindings:** expose transferred_frame on Transfer ([1090802](https://github.com/Fuse-Technical-Group/pydecklink/commit/1090802f00c2d13d77ffb9cc50ed6830ad993bb0))
* **bindings:** release GIL on blocking calls and bind output VBI ([d6d0442](https://github.com/Fuse-Technical-Group/pydecklink/commit/d6d044213f977819d29ba8c36ddaa99a49cda234))
* build foundation — pydecklink scaffold and devcontainer ([e2e5237](https://github.com/Fuse-Technical-Group/pydecklink/commit/e2e52379d561ff7ea275c6fb376ad98af5998502))
* **build:** replace pyntv2 build config with pydecklink ([441f421](https://github.com/Fuse-Technical-Group/pydecklink/commit/441f421ad303c7321f0be17af9b5da96fa5692d4))
* **card:** bind CNTV2Card with full Phase 1 API surface ([3ad8c96](https://github.com/Fuse-Technical-Group/pydecklink/commit/3ad8c9684a6eb8041d69322879280b1e7223d70a))
...
* DeckLink passthrough example and integration tests ([e1a16fa](https://github.com/Fuse-Technical-Group/pydecklink/commit/e1a16fae85e7e4c6800d589266dcb9430045214b))
...
* **devcontainer:** expose Blackmagic firmware tools on PATH ([27a6550](https://github.com/Fuse-Technical-Group/pydecklink/commit/27a6550a1fb5a6744d76c293ddd832aac98b0260))
* **device:** add display mode query and validation methods ([adef7c3](https://github.com/Fuse-Technical-Group/pydecklink/commit/adef7c32da2050e4d8c360686fd0154ce7bdac6e))
* **device:** add display mode query methods ([d1c6ee8](https://github.com/Fuse-Technical-Group/pydecklink/commit/d1c6ee8aad44eb721f39a9972d8178e471521734))
* **device:** add display mode query methods ([d8ec255](https://github.com/Fuse-Technical-Group/pydecklink/commit/d8ec2552d12a778a27dedb75d7a9c16cce412476))
...
* **enums:** bind 10 NTV2 enums with Pythonic names ([5ecb3fa](https://github.com/Fuse-Technical-Group/pydecklink/commit/5ecb3fac66662d6569b074c1a1e2504bf32cb395))
...
* **examples:** add DeckLink SDI passthrough example ([f86e886](https://github.com/Fuse-Technical-Group/pydecklink/commit/f86e886e7af88587ebb144537964e6356a9b02d8))
...
* **examples:** auto-detect input mode in external-source CUDA examples ([04a0ccd](https://github.com/Fuse-Technical-Group/pydecklink/commit/04a0ccd26a7be046573c08b803bb431390fabad4))
...
* **examples:** rewrite passthrough to use zero-copy and two-thread pipeline ([6cdead2](https://github.com/Fuse-Technical-Group/pydecklink/commit/6cdead2027118130caed32ac5dc9453c5c435b90))
...
* **examples:** synchronized output fanout in cuda_passthrough ([290fdab](https://github.com/Fuse-Technical-Group/pydecklink/commit/290fdaba5bf0bddca0c15418828fed5f90e4693b))
* **format:** add get_mode_frame_duration for native frame rate ([6afd424](https://github.com/Fuse-Technical-Group/pydecklink/commit/6afd4240f1be11861667acd18648f358847bbe7d))
* **format:** add get_mode_frame_duration for native frame rate access ([225ec95](https://github.com/Fuse-Technical-Group/pydecklink/commit/225ec955e20a0982c6beaec0756a52178b163b87))
* **input:** add video capture bindings ([0ed736f](https://github.com/Fuse-Technical-Group/pydecklink/commit/0ed736f25730a2f6f4919c6bfcc97711ee3f71ff))
...
* integration blockers — GIL release, output VBI, format metadata, transfer status ([38b8841](https://github.com/Fuse-Technical-Group/pydecklink/commit/38b8841c39781194324b336eef2b9b9132e4fbff))
...
* **output:** add synchronous and scheduled video output bindings ([e2fac75](https://github.com/Fuse-Technical-Group/pydecklink/commit/e2fac751d82c92b0685862a06bdda757af76bbb3))
* **output:** remove schedule_frame, use pool API for scheduled playback ([7af7860](https://github.com/Fuse-Technical-Group/pydecklink/commit/7af78607d595cf94d9881c84ea0f8c0647b2b15a)), closes [#100](https://github.com/Fuse-Technical-Group/pydecklink/issues/100)
* **pydecklink:** add output frame pool and capture timing instrumentation ([fa22c46](https://github.com/Fuse-Technical-Group/pydecklink/commit/fa22c46b32f698d85b6d1fb085963e3ce337e94b))
* **pydecklink:** add profile management, zero-copy capture, and passthrough support ([facfe36](https://github.com/Fuse-Technical-Group/pydecklink/commit/facfe36c5d3a83ef6396a277cf3bb2ec7f95e4ca))
* **pydecklink:** zero-copy capture, profile management, passthrough ([b502003](https://github.com/Fuse-Technical-Group/pydecklink/commit/b502003dc0dbfe07a3c21a49aaa80de4f8cf1861))
* reliability engineering (Spec §9) ([0f44b4d](https://github.com/Fuse-Technical-Group/pydecklink/commit/0f44b4d61a009cd7e522e0cbf89b9a86d99bfcda))
...
* **routing:** add route_capture and route_playout convenience helpers ([2953b22](https://github.com/Fuse-Technical-Group/pydecklink/commit/2953b22e41e5c47705534d77ba02293cdd6fd7d5))
* **scripts:** add PCI card reset script for DMA timeout recovery ([cd12a07](https://github.com/Fuse-Technical-Group/pydecklink/commit/cd12a07d9f37e98112194214443a12c8f033d2de))
...
* **stubs:** generate .pyi type stubs for pydecklink._bindings ([132c1c7](https://github.com/Fuse-Technical-Group/pydecklink/commit/132c1c7bee6a7e060727646c6715e0a5480ba478))
* **test:** add 4K/60 DMA throughput benchmark ([8c8f738](https://github.com/Fuse-Technical-Group/pydecklink/commit/8c8f738dc35900071daf4f197e8b4599e64910af))
* **transfer:** bind AUTOCIRCULATE_TRANSFER and AUTOCIRCULATE_STATUS ([8b3a797](https://github.com/Fuse-Technical-Group/pydecklink/commit/8b3a79727cf8ec041f63652405a18edf7ed03f77))
...
* **bindings:** add contiguity validation to DMA buffer methods ([9ef2bc4](https://github.com/Fuse-Technical-Group/pydecklink/commit/9ef2bc472944df8fd11636be103ede96f51d5935))
...
* **bindings:** enrich error messages with argument values and AC state ([4f0b2fe](https://github.com/Fuse-Technical-Group/pydecklink/commit/4f0b2fe4b464f3746b9305a8b970b12c536324db))
...
* **build:** enable abi3 wheel tag for Python 3.12+ compatibility ([5698fbe](https://github.com/Fuse-Technical-Group/pydecklink/commit/5698fbea2373e9542c1b56aed037b2f5591a676d))
* **build:** forward DECKLINK_SDK_DIR to CMake for isolated builds ([b88227d](https://github.com/Fuse-Technical-Group/pydecklink/commit/b88227dcd96dfdcd0de0ffa015dbdd10d8acdf6d))
* **build:** forward DECKLINK_SDK_DIR to CMake for isolated builds ([71319b9](https://github.com/Fuse-Technical-Group/pydecklink/commit/71319b91b6914510207acf480400fe81e709545a))
* **build:** move _host_frame_refs binding to always-compiled module ([ffffe11](https://github.com/Fuse-Technical-Group/pydecklink/commit/ffffe11f8c2022edafee7572064c1ea88c599785))
* **build:** remove _host_frame_refs from committed stub ([c8bb10b](https://github.com/Fuse-Technical-Group/pydecklink/commit/c8bb10b3e2c7bcf601b19c9967b13129ceaa3fa2))
* **build:** remove unused noqa directive in pydecklink __init__ ([fa868bf](https://github.com/Fuse-Technical-Group/pydecklink/commit/fa868bf7637d0248979e0000e1c6afaf657d97c1))
* **build:** request SABIModule so nanobind actually enables stable ABI ([cf837ef](https://github.com/Fuse-Technical-Group/pydecklink/commit/cf837ef151addd485c424e97690878e29069b548))
* **build:** request SABIModule so nanobind enables stable ABI ([51e2ddc](https://github.com/Fuse-Technical-Group/pydecklink/commit/51e2ddc10409d55902a6d6f6892a6492d1f4916c))
...
* **ci:** skip SDK-dependent tests when built without DeckLink headers ([4495711](https://github.com/Fuse-Technical-Group/pydecklink/commit/449571173e0e5a68876642d34a9c7e8437aeac96))
* **ci:** update ci-linux for pydecklink build ([c7851de](https://github.com/Fuse-Technical-Group/pydecklink/commit/c7851de74a5e7a0b3c363f9a34ebff22f75537c4))
* clock_us docs ([baa0775](https://github.com/Fuse-Technical-Group/pydecklink/commit/baa0775139aa65d23764b49abb3531681680eee0))
* **devcontainer:** add CAP_SYS_ADMIN for capture DMA ([4c33a08](https://github.com/Fuse-Technical-Group/pydecklink/commit/4c33a084336f90624399f3200e15a6ef5ca22160))
* **devcontainer:** add CAP_SYS_RAWIO for capture DMA ([1110f45](https://github.com/Fuse-Technical-Group/pydecklink/commit/1110f4574921a909db7acb7cd3b675c56b474988))
* **devcontainer:** add ldconfig conf and postCreateCommand for Desktop Video libs ([b3cee30](https://github.com/Fuse-Technical-Group/pydecklink/commit/b3cee308fd7a021fb28b49aae6578450799b34ef))
* **devcontainer:** add ldconfig for Desktop Video libs ([bc287ac](https://github.com/Fuse-Technical-Group/pydecklink/commit/bc287ac2c90448aa11ae2d58e07aad4304bc0bc6))
* **devcontainer:** add sudo and fix .claude volume ownership ([79dd390](https://github.com/Fuse-Technical-Group/pydecklink/commit/79dd3904e4726f06f1955cf1f200bebf9ba4116d))
* **devcontainer:** add sudo and fix .claude volume ownership ([1216827](https://github.com/Fuse-Technical-Group/pydecklink/commit/1216827634a4f919e904cc75672730f023a6d700))
* **devcontainer:** bind-mount Claude config instead of named volume ([0b8053d](https://github.com/Fuse-Technical-Group/pydecklink/commit/0b8053d76026ad95a3dab5cdc3626926017dee07))
* **devcontainer:** drop --privileged in favor of --userns=keep-id ([96edafe](https://github.com/Fuse-Technical-Group/pydecklink/commit/96edafe43e13eb95ede7e78e070cb783068ec9c7))
...
* **devcontainer:** mount all Desktop Video binaries from host ([80d1285](https://github.com/Fuse-Technical-Group/pydecklink/commit/80d1285020f2b4c3a018229e85f05b593413834b))
* **devcontainer:** mount all Desktop Video binaries from host lib64 ([d87585c](https://github.com/Fuse-Technical-Group/pydecklink/commit/d87585c555dea663a598522d3ac5a22b1b8a8c54))
* **devcontainer:** move UV_INSTALL_DIR to sh invocation ([b22806d](https://github.com/Fuse-Technical-Group/pydecklink/commit/b22806d02895b2703d940890c0c15572d007dc5f))
* **devcontainer:** move UV_INSTALL_DIR to sh invocation ([f05f328](https://github.com/Fuse-Technical-Group/pydecklink/commit/f05f328e5e339de2c0808c3399cca8460aeee38e))
* **devcontainer:** use community fish feature and correct lib64 path ([ee74c82](https://github.com/Fuse-Technical-Group/pydecklink/commit/ee74c82bf9a4057d5e926a794b164c80be6c5645))
* **devcontainer:** use community fish feature and correct lib64 path ([4f85260](https://github.com/Fuse-Technical-Group/pydecklink/commit/4f85260033ee9bab93e78b5e32ff63d05e6cb035))
* **devcontainer:** use privileged mode and set memlock in Dockerfile ([5a41762](https://github.com/Fuse-Technical-Group/pydecklink/commit/5a41762774df3a86f295c85e12d48a8ca9b52d49))
* **dma:** require page-aligned buffers and improve resource cleanup ([ca6c7c7](https://github.com/Fuse-Technical-Group/pydecklink/commit/ca6c7c7dea3c41331d283ab1a3358d85b7c3d9c7))
* **docs:** merge adjacent blockquotes to fix MD028 ([73479f6](https://github.com/Fuse-Technical-Group/pydecklink/commit/73479f6e83376505f6d799daf684718e47ce0a4d))
* **docs:** merge adjacent blockquotes to fix MD028 lint violation ([bf70117](https://github.com/Fuse-Technical-Group/pydecklink/commit/bf70117352389e630342c4de7853a8503b36b239))
* document 32-bit DMA constraint, remove GPU RDMA, fix buffer lock test ([1148853](https://github.com/Fuse-Technical-Group/pydecklink/commit/11488539a9dcf0c3e2400f1d4b35a444f6bc65c2))
* eliminate raw pointer usage of com objects ([f0a846a](https://github.com/Fuse-Technical-Group/pydecklink/commit/f0a846aa3104863e95a8bd8d1d900a9b96149393))
...
* **examples:** reduce passthrough pre-roll from 60 to 3 frames ([717b664](https://github.com/Fuse-Technical-Group/pydecklink/commit/717b664c9b15d9a8885c9709627cebb3f3af8c73))
* **examples:** reduce passthrough pre-roll from 60 to 3 frames ([e30ff2a](https://github.com/Fuse-Technical-Group/pydecklink/commit/e30ff2a625c0b1829af977f0551eb3956efd1233))
...
* fix lint error ([c72abdd](https://github.com/Fuse-Technical-Group/pydecklink/commit/c72abddc2785def5615f9b876167534b83dd1061))
* fix usage of ComPtr. Let it deal with all ownership of com resources. ([eea26df](https://github.com/Fuse-Technical-Group/pydecklink/commit/eea26df3a7f3b9495ebd6c28365c7480ffe7bb51))
...
* **lint:** disable MD012/MD022 for release-please compatibility ([6682878](https://github.com/Fuse-Technical-Group/pydecklink/commit/668287866c8cf5a5d8bab7f14e308002248c2435))
...
* optimize allocation count management by removing unnecessary mutex lock ([1c2f68a](https://github.com/Fuse-Technical-Group/pydecklink/commit/1c2f68ac218bef824a574c06dbe471fed7f6d24d))
...
* **passthrough:** bound the preroll loop with a timeout ([cca4c1c](https://github.com/Fuse-Technical-Group/pydecklink/commit/cca4c1c1f66909bc395a13c02002d425f2c70507))
...
* **pydecklink:** fix UAF in frame data views and add missing accessors ([9d0bc81](https://github.com/Fuse-Technical-Group/pydecklink/commit/9d0bc811242c356c5d80991f9097a6c61a30fef5))
* **pydecklink:** fix UAF in frame data views, add CaptureFrameRef.data ([f91872f](https://github.com/Fuse-Technical-Group/pydecklink/commit/f91872fb3ec7531c877f7eacea28e7243cbb4c6c))
...
* rename misleading release method to detach ([4d0a6fc](https://github.com/Fuse-Technical-Group/pydecklink/commit/4d0a6fca76331c1904e76a6d650f19de07f20bcf))
* replace raw COM pointers with ComPtr to fix memory leaks ([ab549d2](https://github.com/Fuse-Technical-Group/pydecklink/commit/ab549d277396bee2b2d8440f7d2bee419fd5a0dd))
...
* **routing:** replace bare KeyError with descriptive ValueError ([795dbcb](https://github.com/Fuse-Technical-Group/pydecklink/commit/795dbcb0778f0756e26e4bbb1836287d3d9c51b7))
* ruff errors ([6de48cf](https://github.com/Fuse-Technical-Group/pydecklink/commit/6de48cf42cd80e7cbe7e5f5cf3b1471f9f6581c3))
* **test:** add DMA buffer locking to integration loopback test ([b63a4ab](https://github.com/Fuse-Technical-Group/pydecklink/commit/b63a4ab5493d0169bf580f2062fe219503a6f00b))
* **test:** compare only active frame region in loopback integrity tests ([4d83447](https://github.com/Fuse-Technical-Group/pydecklink/commit/4d83447b67ce5182cdca647d2b8118b26df82ba0))
* **test:** exclude warmup drops from dropped-frame assertions ([372bf7e](https://github.com/Fuse-Technical-Group/pydecklink/commit/372bf7e20dc3209fed4eb288b6edd83ae206798c))
...
* **test:** mark container environment tests as hardware ([fb565e1](https://github.com/Fuse-Technical-Group/pydecklink/commit/fb565e14420b3e88b333236f876038bae793b7e0))
* **test:** release stream ownership in probe finally blocks ([216173f](https://github.com/Fuse-Technical-Group/pydecklink/commit/216173f25a0fc7c3c710421bb48a5909908cc2b4))
* **tests:** correct capture DMA probe and format detection test ([9ab9840](https://github.com/Fuse-Technical-Group/pydecklink/commit/9ab9840d8df4366465a759e6b7c805909afb4f66))
* **tests:** skip integration tests when capture DMA is denied ([e998e6d](https://github.com/Fuse-Technical-Group/pydecklink/commit/e998e6d7d7302385af4e25c71b26c7a83e120647))
...
* **test:** upgrade integration tests to 4K/60 and fix SDI loopback assertion ([0bb3117](https://github.com/Fuse-Technical-Group/pydecklink/commit/0bb3117e8c4c7bc54621f99e103faee00ab7ddd9))
...
* **test:** use page-aligned buffer in DMA buffer lock test ([bf271a1](https://github.com/Fuse-Technical-Group/pydecklink/commit/bf271a118a750c3f60f17a9827db79fe0554781e))
...
* update allocator management to use ComPtr for better memory handling ([6f9a634](https://github.com/Fuse-Technical-Group/pydecklink/commit/6f9a6348597eab60f227b425004a97eef696c5ba))
